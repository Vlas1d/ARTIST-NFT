document.addEventListener('DOMContentLoaded', () => {
    ...
    const goToPersonalCab = (cabinet) => {
        switch (cabinet) {
            case 'admin':
                document.location.href = '/ARTIST-NFT/personal-cabinet-owner.html'
                break;
            case 'customer':
                document.location.href = '/ARTIST-NFT/personal-cabinet-client.html'
                break;
            case 'artist':
                document.location.href = '/ARTIST-NFT/personal-cabinet-worker.html'
                break;
            default:
                break;
        }
